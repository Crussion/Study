...
(seq_imageboard.nextval, 'image_001', '컵라면', 1000, 10,
...
-- 데이터 수정
update imageboard set imageId='123', imageName='123', imagePrice=1000, imageQty=5, imageContent='123', image1='aaa' where seq=1;