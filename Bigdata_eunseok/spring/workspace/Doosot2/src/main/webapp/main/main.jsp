...
<meta charset="UTF-8">
<title>두솥</title>
<link rel="stylesheet" type="text/css" href="../css/main_css.css?v=2">
...
<script type="text/javascript">
	...
	function auto_slide(wait_time, time){
		auto = setInterval(function(){
			...
			$(".b_btn:eq(" + index + ")").css("border", "3px solid yellow")
	...
	$(function(){
		...
		$(".b_btn").first().css("margin-left", $(".main_top_list").css("margin-left"))
		$(".b_btn").first().css("border", "3px solid yellow")
...
<body>
	<header>
		...
		<div class="banner">
			<div class="slide active_slide" data-img-url="../img/banner1.jpg" data-index="0"></div>
	...
	<div id="container">
		...
		<div class="brand_img">
			<a href="../brand/brand.jsp"><img src="../img/main_bottom.png" alt="메인아래쪽"></a>
		</div>
	</div>
	<footer>
		<div id="footer_head">
