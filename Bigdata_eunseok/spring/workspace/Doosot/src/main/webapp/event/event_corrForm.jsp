...
<body>
	...
	<div class="container">
		<div class="subject" align="center">
			<span class="title">이벤트 수정</span>
		</div>
		<br><br>
		<div class="content">
	      <form action="eventCorr.do?pg=${pg}&eve_num=${eve_num}" id="frm" name="event_frm" method="post" enctype="multipart/form-data">
	         <table class="event_write_form">
	            <tr>
	               <td width="120"><span>이벤트 이름</span></td>
	               <td><input type="text" name="eve_name" class="input" value="${dto.eve_name}"></td>
	            </tr>
	            <tr>
	               <td><span>시작일</span></td>
	               <td><input type="date" name="eve_start" class="input" value="${dto.eve_start}"></td>
	            </tr>
	            <tr>
	               <td><span>종료일</span></td>
	               <td><input type="date" name="eve_end" class="input" value="${dto.eve_end}"></td>
	            </tr>
	            <tr>
	               <td><span>행사 이미지</span></td>
	               <td><input type="file" class="input" name="eve_img" id="file" value="${dto.eve_img}"></td>
	            </tr>
	            <tr>
	               <td colspan="2">
