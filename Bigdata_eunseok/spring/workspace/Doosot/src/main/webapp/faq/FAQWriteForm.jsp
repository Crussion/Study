...
<meta charset="UTF-8">
<title>FAQ 등록</title>
<link rel="stylesheet" type="text/css" href="../css/write.css?v=7">
	...
	<div class="content">
		...
		<form action="FAQWriteForm.do" id="frm"
			...
			<table id="faqWriteForm">
				...
				<tr align="center">
					<td><input type="hidden" name="faq_id" value="${login_id}"></td>
				</tr>
				<tr align="center">
					<td colspan="2">
					<input type="button" value="등록 하기" onclick="FAQWrite()">
